...
mij_container_group = L.featureGroup();
mij_events_group = L.featureGroup();
mij_photo_ops_group = L.featureGroup();
mij_feats_group = L.featureGroup();
...
mij_event01_marker.bindPopup("<b style=\"font-size:20px\">Kyusha Spirit</b><br>\
                              ...
                              <img src=\"img/MIJ/kyusha_spirit.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event02_marker.bindPopup("<b style=\"font-size:20px\">Wangan Spirit</b><br>\
                              ...
                              <img src=\"img/MIJ/wangan_spirit.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event03_marker.bindPopup("<b style=\"font-size:20px\">Touge Spirit</b><br>\
                              ...
                              <img src=\"img/MIJ/touge_spirit.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event04_marker.bindPopup("<b style=\"font-size:20px\">Ebisu Style</b><br>\
                              ...
                              <img src=\"img/MIJ/ebisu_style.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event05_marker.bindPopup("<b style=\"font-size:20px\">Zeroyon Style</b><br>\
                              ...
                              <img src=\"img/MIJ/zeroyon_style.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event06_marker.bindPopup("<b style=\"font-size:20px\">Kanjo Style</b><br>\
                              ...
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/blue_xp.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">10,800</span></span><br>\
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/bucks.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">20,250</span></span><br>\
                              <img src=\"img/MIJ/kanjo_style.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});
...
mij_event07_marker.bindPopup("<b style=\"font-size:20px\">Shinjuku Style</b><br>\
                              ...
                              <img src=\"img/MIJ/shinjuku_style.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Feats
var featsArr = [[512.404716, 2365.481603, "speedtrap", "Oahu Airport", "Speedtrap", "210.0 km/h", "960", "1,800"],  //Feat 01
...
function createFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["mij_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(mij_feats_group);
...
mij_container_group.addTo(map);
mij_events_group.addTo(map);
mij_feats_group.addTo(map);
mij_collectibles_group.addTo(map);
mij_photo_ops_group.addTo(map);