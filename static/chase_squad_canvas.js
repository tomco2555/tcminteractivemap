...
tcs_photo_ops_group = [];
tcs_feats_group = [];
tcs_collectibles_group = [];

//Container
tcs_container_marker = L.marker([1400.43992, 5347.495033], {icon:tcs_container_icon});
...
//Events
//Event 01
tcs_event01_marker = L.marker([1385.940402, 5378.519343], {icon:tcs_event_icon});
...
//Event 02
tcs_event02_marker = L.marker([1346.165273, 5375.867692], {icon:tcs_event_icon});
...
//Event 03
tcs_event03_marker = L.marker([1490.234129, 4609.010388], {icon:tcs_event_icon});
...
//Event 04
tcs_event04_marker = L.marker([1493.240948, 5344.047887], {icon:tcs_event_icon});
...
//Event 05
tcs_event05_marker = L.marker([1508.614803, 5430.049749], {icon:tcs_event_icon});
...
//Event 06
tcs_event06_marker = L.marker([206.63594, 5517.475061], {icon:tcs_event_icon});
...
//Event 07
tcs_event07_marker = L.marker([734.939713, 5740.904939], {icon:tcs_event_icon});
...
//Event 08
tcs_event08_marker = L.marker([832.158753, 5982.24221], {icon:tcs_event_icon});
...
//Event 09
tcs_event09_marker = L.marker([1664.340936, 5077.5], {icon:tcs_event_icon});
...
function createTCSFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["tcs_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]});
...
tcs_photo_ops01_marker = L.marker([1645.618085, 5282.441209], {icon:photo_op_icon});
...
tcs_photo_ops02_marker = L.marker([537.256714, 6081.875], {icon:photo_op_icon});
...
tcs_photo_ops03_marker = L.marker([1686.781799, 5354.212547], {icon:photo_op_icon});
...
tcs_photo_ops04_marker = L.marker([1366.859382, 5353.682217], {icon:photo_op_icon});
...
tcs_photo_ops05_marker = L.marker([1651.964993, 5368.177906], {icon:photo_op_icon});
...
tcs_photo_ops06_marker = L.marker([1213.432324, 5255.924705], {icon:photo_op_icon});
...
tcs_collectible01_marker = L.marker([1772.544324, 5377.193518], {icon:collectible_icon});
...
tcs_collectible02_marker = L.marker([1691.085142, 5376.309634], {icon:collectible_icon});
...
tcs_collectible03_marker = L.marker([1538.012433, 5323.983732], {icon:collectible_icon});
...
tcs_collectible04_marker = L.marker([1592.273781, 5212.437638], {icon:collectible_icon});
...
tcs_container_group.push(tcs_container_marker);

for(var i = 1; i <= 9; i++) {
    if(i < 10) {
        tcs_events_group.push(window["tcs_event0" + i + "_marker"]);
    }
    else {
        tcs_events_group.push(window["tcs_event" + i + "_marker"]);
    }
}

for(var i = 0; i <= 5; i++) {
    tcs_feats_group.push(window["tcs_feat" + i + "_marker"]);
}

for(var i = 1; i <= 6; i++) {
    if(i < 10) {
        tcs_photo_ops_group.push(window["tcs_photo_ops0" + i + "_marker"]);
    }
    else {
        tcs_photo_ops_group.push(window["tcs_photo_ops" + i + "_marker"]);
    }
}

for(var i = 1; i <= 4; i++) {
    if(i < 10) {
        tcs_collectibles_group.push(window["tcs_collectible0" + i + "_marker"]);
    }
    else {
        tcs_collectibles_group.push(window["tcs_collectible" + i + "_marker"]);
    }
}

markers_canvas.addMarkers(tcs_container_group);
markers_canvas.addMarkers(tcs_events_group);
markers_canvas.addMarkers(tcs_collectibles_group);
markers_canvas.addMarkers(tcs_photo_ops_group);
markers_canvas.addMarkers(tcs_feats_group);