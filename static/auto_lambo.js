...
//CONTAINER
al_container_marker = L.marker([378.408662, 3047.541839], {icon:al_container_icon}).addTo(al_container_group);
...
//EVENTS
//Event 01
al_event01_marker = L.marker([1299.127285, 3038.25], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 02
al_event02_marker = L.marker([1746.18017, 2968.8125], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 03
al_event03_marker = L.marker([2131.72454, 1940.654561], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 04
al_event04_marker = L.marker([2027.098986, 1450], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 05
al_event05_marker = L.marker([626.121975, 2134.932149], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 06
al_event06_marker = L.marker([667.403908, 2153.228537], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 07
al_event07_marker = L.marker([515.131068, 3719.293281], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 08
al_event08_marker = L.marker([515.502285, 2987.375], {icon:al_event_icon}).addTo(al_events_group);
...
//Event 09
al_event09_marker = L.marker([734.739524, 2572.875], {icon:al_event_icon}).addTo(al_events_group);
...
al_photo_ops01_marker = L.marker([2107.119762, 2019.125], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops02_marker = L.marker([501.787063, 1800.735807], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops03_marker = L.marker([556.744059, 3602.25], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops04_marker = L.marker([725.488434, 2708.875], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops05_marker = L.marker([531.510827, 2772.625], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops06_marker = L.marker([2172.300917, 1782.625], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_photo_ops07_marker = L.marker([2179.108337, 2680.875], {icon:photo_op_icon}).addTo(al_photo_ops_group);
...
al_collectible01_marker = L.marker([2187.488272, 1794.052502], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible02_marker = L.marker([1591.768069, 2299.75], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible03_marker = L.marker([1247.883648, 3166.125], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible04_marker = L.marker([546.258831, 2999.546966], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible05_marker = L.marker([567.195782, 2146.687799], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible06_marker = L.marker([643.832954, 2014.989161], {icon:collectible_icon}).addTo(al_collectibles_group);
...
al_collectible07_marker = L.marker([575.683773, 1589.841209], {icon:collectible_icon}).addTo(al_collectibles_group);
