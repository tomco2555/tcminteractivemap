...
//MOTORFEST GROUNDS
mf_grounds_marker = L.marker([668.040568, 3407], {icon:mf_grounds_icon}).addTo(mf_grounds_group);
...
//DEMO ROYALE
//DR 01
demo_royale_01_marker = L.marker([2033.490898, 1799.518329], {icon:demo_royale_icon}).addTo(demo_royale_group);
...
//DR 02
demo_royale_02_marker = L.marker([2108.851303, 2731.231557], {icon:demo_royale_icon}).addTo(demo_royale_group);
...
//DR 03
demo_royale_03_marker = L.marker([1406.266193, 1722.954061], {icon:demo_royale_icon}).addTo(demo_royale_group);
...
//DR 04
demo_royale_04_marker = L.marker([1741.259738, 2266.625], {icon:demo_royale_icon}).addTo(demo_royale_group);
...
//GRAND RACE
//GR 01
grand_race_01_marker = L.marker([2034.354437, 1806.922991], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 02
grand_race_02_marker = L.marker([2109.125773, 2736.25], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 03
grand_race_03_marker = L.marker([1406.700894, 1728.375], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 04
grand_race_04_marker = L.marker([1744.388077, 2270.5], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 05
grand_race_05_marker = L.marker([459.355913, 3359.807402], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 06
grand_race_06_marker = L.marker([512.401843, 1810.546913], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 07
grand_race_07_marker = L.marker([1863.930045, 1012.046581], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 08
grand_race_08_marker = L.marker([446.78874, 3008], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 09
grand_race_09_marker = L.marker([895.519716, 2745.165301], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 10
grand_race_10_marker = L.marker([1333.021803, 3026.770577], {icon:grand_race_icon}).addTo(grand_race_group);
...
//GR 11
grand_race_11_marker = L.marker([2440.067629, 2441.875], {icon:grand_race_icon}).addTo(grand_race_group);
...
achievement_01_marker = L.marker([1401.516464, 1378.50467], {icon:achievement_icon}).addTo(achievements_group);
...
achievement_02_marker = L.marker([497.644593, 2811.279785], {icon:achievement_icon}).addTo(achievements_group);
...
achievement_03_marker = L.marker([1326.193402, 2183.5], {icon:achievement_icon}).addTo(achievements_group);
...
achievement_04_marker = L.marker([638.352537, 2962.625], {icon:achievement_icon}).addTo(achievements_group);
...
achievement_05_marker = L.marker([1736.185783, 2224.857861], {icon:achievement_icon}).addTo(achievements_group);
...
achievement_06_marker = L.marker([659.49613, 3422.027962], {icon:achievement_icon}).addTo(achievements_group);
...
treasure_01_marker = L.marker([345.971133, 3529.700275], {icon:treasure_icon}).addTo(treasure_group);
treasure_01_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 02 Waikiki Shell(HNL)
treasure_02_marker = L.marker([482.790404, 2983.725452], {icon:treasure_icon}).addTo(treasure_group);
treasure_02_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 03 State Capitol(HNL)
treasure_03_marker = L.marker([685.745641, 2645.75], {icon:treasure_icon}).addTo(treasure_group);
treasure_03_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 04 Oahu Airport(HNL)
treasure_04_marker = L.marker([482.619792, 2446.854628], {icon:treasure_icon}).addTo(treasure_group);
treasure_04_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 05 USS Submarine Museum
treasure_05_marker = L.marker([775.93917, 2261.3125], {icon:treasure_icon}).addTo(treasure_group);
treasure_05_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 06 Ewa
treasure_06_marker = L.marker([591.514976, 2074.125], {icon:treasure_icon}).addTo(treasure_group);
treasure_06_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 07 Barbers Point Harbor
treasure_07_marker = L.marker([438.444286, 1806.657826], {icon:treasure_icon}).addTo(treasure_group);
treasure_07_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 08 Aulinaii Resort
treasure_08_marker = L.marker([664.508867, 1584.272743], {icon:treasure_icon}).addTo(treasure_group);
treasure_08_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 09 Diamond Head
treasure_09_marker = L.marker([325.994273, 3209.380903], {icon:treasure_icon}).addTo(treasure_group);
treasure_09_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 10 Makakilo River Gorge
treasure_10_marker = L.marker([826.940664, 1847.869873], {icon:treasure_icon}).addTo(treasure_group);
treasure_10_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 11 Maili Point
treasure_11_marker = L.marker([1314.091588, 1316.898229], {icon:treasure_icon}).addTo(treasure_group);
treasure_11_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 12 Waianae
treasure_12_marker = L.marker([1624.438098, 1354.6875], {icon:treasure_icon}).addTo(treasure_group);
treasure_12_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 13 Kaena Point
treasure_13_marker = L.marker([1955.856213, 991.894037], {icon:treasure_icon}).addTo(treasure_group);
treasure_13_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 14 Mokuleia Beach
treasure_14_marker = L.marker([2039.989454, 1293.25], {icon:treasure_icon}).addTo(treasure_group);
treasure_14_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 15 Makaleha River - Peacock River
treasure_15_marker = L.marker([1915.776366, 1502.75], {icon:treasure_icon}).addTo(treasure_group);
treasure_15_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 16 Peacock Flats Farm
treasure_16_marker = L.marker([1840.691648, 1797.875], {icon:treasure_icon}).addTo(treasure_group);
treasure_16_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 17 Haleiwa Island Resort
treasure_17_marker = L.marker([2151.566226, 1779.1875], {icon:treasure_icon}).addTo(treasure_group);
treasure_17_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 18 Haleiwa Fields Farm
treasure_18_marker = L.marker([1994.853347, 2041.505666], {icon:treasure_icon}).addTo(treasure_group);
treasure_18_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 19 Pineapple Plantation
treasure_19_marker = L.marker([1785.132101, 2207.25], {icon:treasure_icon}).addTo(treasure_group);
treasure_19_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 20 Japanese Jodo
treasure_20_marker = L.marker([1415.197765, 2013.25], {icon:treasure_icon}).addTo(treasure_group);
treasure_20_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 21 Nanakuli River under the Mauna Pele
treasure_21_marker = L.marker([1072.208505, 1755.4375], {icon:treasure_icon}).addTo(treasure_group);
treasure_21_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 22 Kunia Fields Farm
treasure_22_marker = L.marker([1169.91047, 2078.375], {icon:treasure_icon}).addTo(treasure_group);
treasure_22_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 23 Multicultural Heritage
treasure_23_marker = L.marker([1192.449659, 2417.598085], {icon:treasure_icon}).addTo(treasure_group);
treasure_23_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 24 Mililani Fields Farm
treasure_24_marker = L.marker([1458.504992, 2311.5625], {icon:treasure_icon}).addTo(treasure_group);
treasure_24_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 25 Pearl Botanical Garden
treasure_25_marker = L.marker([971.306388, 2599.147751], {icon:treasure_icon}).addTo(treasure_group);
treasure_25_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 26 Stairway To Heaven
treasure_26_marker = L.marker([1007.805232, 3051.696091], {icon:treasure_icon}).addTo(treasure_group);
treasure_26_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 27 Koko Crater
treasure_27_marker = L.marker([630.570277, 3799.196347], {icon:treasure_icon}).addTo(treasure_group);
treasure_27_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 28 Coconut Resort
treasure_28_marker = L.marker([911.991985, 3645.125], {icon:treasure_icon}).addTo(treasure_group);
treasure_28_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 29 Kailua
treasure_29_marker = L.marker([1101.658147, 3338.427891], {icon:treasure_icon}).addTo(treasure_group);
treasure_29_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 30 Kaneohe
treasure_30_marker = L.marker([1392.389197, 3078.300984], {icon:treasure_icon}).addTo(treasure_group);
treasure_30_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 31 Ewa Forest
treasure_31_marker = L.marker([1267.821956, 2715.125], {icon:treasure_icon}).addTo(treasure_group);
treasure_31_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 32 Hindu Monastery
treasure_32_marker = L.marker([1744.961939, 2835.409804], {icon:treasure_icon}).addTo(treasure_group);
treasure_32_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 33 Wahiawa Forest
treasure_33_marker = L.marker([1733.000949, 2499.125], {icon:treasure_icon}).addTo(treasure_group);
treasure_33_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 34 Turtle Rock
treasure_34_marker = L.marker([2297.353943, 2022.25], {icon:treasure_icon}).addTo(treasure_group);
treasure_34_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 35 Ma'akua Black Beach
treasure_35_marker = L.marker([1977.07839, 2939.442889], {icon:treasure_icon}).addTo(treasure_group);
treasure_35_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 36 Leeward Coast
treasure_36_marker = L.marker([1053.143491, 1437.375], {icon:treasure_icon}).addTo(treasure_group);
treasure_36_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 37 Laie Point
treasure_37_marker = L.marker([2179.933725, 2686.38705], {icon:treasure_icon}).addTo(treasure_group);
treasure_37_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 38 Kahuku Black Beach
treasure_38_marker = L.marker([2484.625352, 2561.625], {icon:treasure_icon}).addTo(treasure_group);
treasure_38_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 39 Waimea Hills
treasure_39_marker = L.marker([2348.835903, 2277.325777], {icon:treasure_icon}).addTo(treasure_group);
treasure_39_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 40 Turtle Bay Beach
treasure_40_marker = L.marker([2564.109146, 2260.75], {icon:treasure_icon}).addTo(treasure_group);
treasure_40_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 41 Mokapu
treasure_41_marker = L.marker([1295.000492, 3562.75], {icon:treasure_icon}).addTo(treasure_group);
treasure_41_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 42 Mauna Pele Red Hill
treasure_42_marker = L.marker([1537.344298, 1629.350801], {icon:treasure_icon}).addTo(treasure_group);
treasure_42_marker.bindPopup('<b>Treasure Crate</b><br>', {
                            className: "hstPopup"
});

//Treasure 43 Koolauloa Hills
treasure_43_marker = L.marker([2050.53654, 2375.61362], {icon:treasure_icon}).addTo(treasure_group);
