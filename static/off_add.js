...
//CONTAINER
oa_container_marker = L.marker([1247.316226, 2192.5625], {icon:oa_container_icon}).addTo(oa_container_group);
...
//EVENTS
//Event 01
oa_event01_marker = L.marker([1300.470511, 2157.382789], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 02
oa_event02_marker = L.marker([1814.560461, 1760.75], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 03
oa_event03_marker = L.marker([2323.048966, 2279.875], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 04
oa_event04_marker = L.marker([1429.056366, 1719.75], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 05
oa_event05_marker = L.marker([1100.690101, 1592.375], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 06
oa_event06_marker = L.marker([930.321025, 2655.875], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 07
oa_event07_marker = L.marker([1694.574963, 2850.08227], {icon:oa_event_icon}).addTo(oa_events_group);
...
//Event 08
oa_event08_marker = L.marker([2278.544343, 2284.75], {icon:oa_event_icon}).addTo(oa_events_group);
...
//FEATS
var OAfeatsArr = [[1391.059146, 2134.932149, "escape", "Kunia Fields", "Escape", "560 m", "2,880", "5,400"],  //Feat 01
                  [1442.84741, 2373.227134, "slalom", "Mililani", "Slalom", "5,880 PTS", "2,880", "5,400"],  //Feat 02
                  [1514.501828, 1851.25, "bullseye", "Volcanoes Road", "Bullseye", "8,020 PTS", "3,840", "7,200"],  //Feat 03
                  [1511.296283, 1613.264121, "speedtrap", "Mauna Pele Red Hill", "Speedtrap", "110.0 km/h", "960", "1,800"],  //Feat 04
                  [1886.367231, 2041.75, "escape", "North Fork Kaukonahua River", "Escape", "460 m", "2,880", "5,400"],  //Feat 05
                  [2029.998647, 1295.0625, "slalom", "Mokuleia Beach", "Slalom", "5,900 PTS", "2,880", "5,400"],  //Feat 06
                  [2209.753937, 2139, "speedtrap", "Waimea Road", "Speedtrap", "120.0 km/h", "960", "1,800"],  //Feat 07
                  [2382.862036, 2527.199636, "bullseye", "Koolauloa", "Bullseye", "2,950 PTS", "3,840", "7,200"],  //Feat 08
                  [910.762304, 2063.1875, "escape", "Honouliuli Gulch", "Escape", "610 m", "2,880", "5,400"],  //Feat 09
               ]
...
oa_photo_ops01_marker = L.marker([1793.503667, 1519.749249], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops02_marker = L.marker([1413.008291, 1390.525485], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops03_marker = L.marker([1917.647888, 2627.255245], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops04_marker = L.marker([850.072449, 2541.4375], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops05_marker = L.marker([1635.492618, 1958.25], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops06_marker = L.marker([1977.2775, 1538.419992], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_photo_ops07_marker = L.marker([2094.316771, 2385.6875], {icon:photo_op_icon}).addTo(oa_photo_ops_group);
...
oa_collectible01_marker = L.marker([2342.816877, 2276.4375], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible02_marker = L.marker([1758.583663, 1801.708078], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible03_marker = L.marker([1794.758156, 2480.75], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible04_marker = L.marker([1304.271057, 2830.375], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible05_marker = L.marker([1240.642472, 3502], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible06_marker = L.marker([807.080565, 3870.348967], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible07_marker = L.marker([340.303566, 3527.931558], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible08_marker = L.marker([352.63864, 3132.5], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible09_marker = L.marker([1501.616911, 1378.946612], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible10_marker = L.marker([1948.361993, 1086.25], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible11_marker = L.marker([1741.377215, 1499.25], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible12_marker = L.marker([2095.747996, 1684.125], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible13_marker = L.marker([2100.998829, 2358.643057], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible14_marker = L.marker([2094.378709, 2384.0625], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible15_marker = L.marker([1804.47653, 2499.799248], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible16_marker = L.marker([1994.511531, 2665.25], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible17_marker = L.marker([1010.065154, 3047.3125], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible18_marker = L.marker([961.202282, 3197.375], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible19_marker = L.marker([880.255168, 3647.6875], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible20_marker = L.marker([581.269217, 3773.121784], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible21_marker = L.marker([1699.240249, 2913.600967], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible22_marker = L.marker([1324.678602, 3613.580817], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible23_marker = L.marker([1095.407332, 1656.486023], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible24_marker = L.marker([1823.978164, 1668.41845], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible25_marker = L.marker([1799.881468, 1534.625], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible26_marker = L.marker([2390.733232, 2290.561554], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible27_marker = L.marker([1706.766311, 2333.125], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible28_marker = L.marker([1030.820076, 2912.25], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible29_marker = L.marker([1073.640608, 3101.625], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible30_marker = L.marker([1224.063924, 2950.5625], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible31_marker = L.marker([1407.383191, 1391.8125], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible32_marker = L.marker([884.440106, 3107.027197], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible33_marker = L.marker([788.021444, 2718.375], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible34_marker = L.marker([412.517924, 3135.716186], {icon:collectible_icon}).addTo(oa_collectibles_group);
...
oa_collectible35_marker = L.marker([635.086435, 3801.406056], {icon:collectible_icon}).addTo(oa_collectibles_group);
