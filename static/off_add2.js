...
//CONTAINER
oa2_container_marker = L.marker([2041.95944, 1561.114996], {icon:oa2_container_icon}).addTo(oa2_container_group);
...
//EVENTS
//Event 01
oa2_event01_marker = L.marker([1822.767026, 1776.782564], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 02
oa2_event02_marker = L.marker([1835.636706, 1556.375], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 03
oa2_event03_marker = L.marker([2251.257106, 2630.967556], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 04
oa2_event04_marker = L.marker([2074.080852, 1891.176038], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 05
oa2_event05_marker = L.marker([1385.913295, 2789.285288], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 06
oa2_event06_marker = L.marker([1154.731605, 3545.769664], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 07
oa2_event07_marker = L.marker([881.970517, 3094.316913], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 08
oa2_event08_marker = L.marker([1044.832538, 1589.189113], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 09
oa2_event09_marker = L.marker([2263.195075, 2235.114773], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
oa2_photo_ops01_marker = L.marker([783.515679, 3538.75], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops02_marker = L.marker([1957.428237, 1411.11997], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops03_marker = L.marker([1833.50581, 1644.730373], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops04_marker = L.marker([847.651084, 1844], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops05_marker = L.marker([885.68331, 1706.602216], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops06_marker = L.marker([1006.58624, 2923.35621], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_collectible01_marker = L.marker([738.262163, 3533.375], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible02_marker = L.marker([2134.37726, 2301.279019], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible03_marker = L.marker([1588.185594, 1730.46707], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible04_marker = L.marker([1409.317806, 1413.152902], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible05_marker = L.marker([1263.525241, 3566.75], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible06_marker = L.marker([2361.374445, 2382.596299], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible07_marker = L.marker([2408.874508, 2187.75], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible08_marker = L.marker([1872.148448, 1504.25], {icon:collectible_icon}).addTo(oa2_collectibles_group);
