...
ons_container_group = L.featureGroup();
ons_events_group = L.featureGroup();
ons_photo_ops_group = L.featureGroup();
ons_feats_group = L.featureGroup();
ons_collectibles_group = L.featureGroup();

//CONTAINER
ons_container_marker = L.marker([1968.091024, 3586.268817], {icon:ons_container_icon}).addTo(ons_container_group);
...
//EVENTS
//Event 01
ons_event01_marker = L.marker([1721.68757, 3709.9375], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 02
ons_event02_marker = L.marker([1707.561059, 3562.1875], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 03
ons_event03_marker = L.marker([1281.445809, 3684.981222], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 04
ons_event04_marker = L.marker([2048.697321, 3191.014317], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 05
ons_event05_marker = L.marker([3254.321684, 2269.264089], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 06
ons_event06_marker = L.marker([2457.365246, 1774.594317], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 07
ons_event07_marker = L.marker([1498.549154, 2195.160092], {icon:ons_event_icon}).addTo(ons_events_group);
...
//Event 08
ons_event08_marker = L.marker([1227.957576, 2393.650946], {icon:ons_event_icon}).addTo(ons_events_group);
...
function createONSFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["ons_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(ons_feats_group);
...
ons_photo_ops01_marker = L.marker([3123.50689, 1866.25], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_photo_ops02_marker = L.marker([1779.9134, 3053.287081], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_photo_ops03_marker = L.marker([1502.50225, 2249], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_photo_ops04_marker = L.marker([3177.426998, 2176.121119], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_photo_ops05_marker = L.marker([2913.716779, 2025.375], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_photo_ops06_marker = L.marker([2582.405084, 3171.5], {icon:photo_op_icon}).addTo(ons_photo_ops_group);
...
ons_collectible01_marker = L.marker([3061.278157, 2429.265347], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible02_marker = L.marker([1864.496947, 1707.220935], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible03_marker = L.marker([2093.034873, 2775.25], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible04_marker = L.marker([2114.818371, 2663.125], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible05_marker = L.marker([1640.63639, 2752.875], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible06_marker = L.marker([1811.523342, 2210.5], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible07_marker = L.marker([1507.322592, 1710.049362], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible08_marker = L.marker([2741.724267, 1400.25], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible09_marker = L.marker([1581.366098, 3872.65297], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible10_marker = L.marker([1045.634654, 3547.9522], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible11_marker = L.marker([1078.267893, 3393.75], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible12_marker = L.marker([1083.270987, 3149.5], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible13_marker = L.marker([1224.586091, 1693.520741], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible14_marker = L.marker([2721.64575, 990.163574], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible15_marker = L.marker([2965.796906, 1751.166785], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible16_marker = L.marker([3134.117899, 1865], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible17_marker = L.marker([3249.758718, 2560.5], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible18_marker = L.marker([1481.005565, 3728.927611], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible19_marker = L.marker([2090.633718, 1913.625], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible20_marker = L.marker([2567.187145, 1514.269172], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible21_marker = L.marker([2798.926875, 1605.662723], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible22_marker = L.marker([2404.198609, 1959.746444], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible23_marker = L.marker([2758.577791, 2672.510079], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible24_marker = L.marker([2632.002988, 2619.125], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_collectible25_marker = L.marker([2351.013656, 2738.978117], {icon:collectible_icon}).addTo(ons_collectibles_group);
...
ons_container_group.addTo(map);
ons_events_group.addTo(map);
ons_feats_group.addTo(map);
ons_collectibles_group.addTo(map);
ons_photo_ops_group.addTo(map);