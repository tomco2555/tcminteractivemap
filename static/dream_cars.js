...
//CONTAINER
dc_container_marker = L.marker([583.381937, 2044.952811], {icon:dc_container_icon}).addTo(dc_container_group);
...
//EVENTS
//Event 01
dc_event01_marker = L.marker([615.110271, 1787.212389], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 02
dc_event02_marker = L.marker([2135.045399, 2033.813092], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 03
dc_event03_marker = L.marker([1482.531242, 3039.630317], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 04
dc_event04_marker = L.marker([1204.030236, 3417.855574], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 05
dc_event05_marker = L.marker([462.979947, 3314.394555], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 06
dc_event06_marker = L.marker([786.774971, 2367.438745], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 07
dc_event07_marker = L.marker([1835.687074, 1462.278799], {icon:dc_event_icon}).addTo(dc_events_group);
...
dc_photo_ops01_marker = L.marker([1369.320435, 1691.929751], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops02_marker = L.marker([671.315506, 1595.75], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops03_marker = L.marker([525.514167, 2805.875], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops04_marker = L.marker([559.857014, 2674.984953], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops05_marker = L.marker([1768.472369, 1756.75], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_collectible01_marker = L.marker([662.405643, 1576.848122], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible02_marker = L.marker([501.397991, 2812.875], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible03_marker = L.marker([541.513745, 2879.875], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible04_marker = L.marker([2537.501933, 2272.25], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible05_marker = L.marker([2171.506539, 1777], {icon:collectible_icon}).addTo(dc_collectibles_group);
