...
//CONTAINER
ha_container_marker = L.marker([1385.373031, 2998.375], {icon:ha_container_icon}).addTo(ha_container_group);
...
//EVENTS
//Event 01
ha_event01_marker = L.marker([1275.533985, 3005.027043], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 02
ha_event02_marker = L.marker([850.83916, 2700.175632], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 03
ha_event03_marker = L.marker([541.177338, 2540.59235], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 04
ha_event04_marker = L.marker([569.508402, 2101.625], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 05
ha_event05_marker = L.marker([666.128972, 1969.5], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 06
ha_event06_marker = L.marker([599.884527, 1673.625], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 07
ha_event07_marker = L.marker([1507.717298, 1933.406716], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 08
ha_event08_marker = L.marker([779.934554, 2644.66775], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 09
ha_event09_marker = L.marker([1244.106052, 2464.75], {icon:ha_event_icon}).addTo(ha_events_group);
...
ha_photo_ops01_marker = L.marker([667.64205, 2765.75], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops02_marker = L.marker([1238.844021, 3053.463858], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops03_marker = L.marker([825.516101, 1841], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops04_marker = L.marker([649.396387, 3819.141294], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops05_marker = L.marker([468.869905, 3010.329161], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_collectible01_marker = L.marker([1073.512339, 3000.5], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible02_marker = L.marker([891.00675, 3657], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible03_marker = L.marker([644.762409, 3002.625], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible04_marker = L.marker([571.701923, 1765.380468], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible05_marker = L.marker([571.138499, 1623.625], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible06_marker = L.marker([667.261249, 1587.375], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible07_marker = L.marker([1136.145436, 1979.137941], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible08_marker = L.marker([1625.501476, 2092.875], {icon:collectible_icon}).addTo(ha_collectibles_group);
