...
ha_container_group = L.featureGroup();
ha_events_group = L.featureGroup();
ha_photo_ops_group = L.featureGroup();
ha_feats_group = L.featureGroup();
ha_collectibles_group = L.featureGroup();

//CONTAINER
ha_container_marker = L.marker([2151.373031, 2998.375], {icon:ha_container_icon}).addTo(ha_container_group);
...
//EVENTS
//Event 01
ha_event01_marker = L.marker([2041.533985, 3005.027043], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 02
ha_event02_marker = L.marker([1616.83916, 2700.175632], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 03
ha_event03_marker = L.marker([1307.177338, 2540.59235], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 04
ha_event04_marker = L.marker([1335.508402, 2101.625], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 05
ha_event05_marker = L.marker([1432.128972, 1969.5], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 06
ha_event06_marker = L.marker([1365.884527, 1673.625], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 07
ha_event07_marker = L.marker([2273.717298, 1933.406716], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 08
ha_event08_marker = L.marker([1545.934554, 2644.66775], {icon:ha_event_icon}).addTo(ha_events_group);
...
//Event 09
ha_event09_marker = L.marker([2010.106052, 2464.75], {icon:ha_event_icon}).addTo(ha_events_group);
...
function createHAFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["ha_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(ha_feats_group);
...
ha_photo_ops01_marker = L.marker([1433.64205, 2765.75], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops02_marker = L.marker([2004.844021, 3053.463858], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops03_marker = L.marker([1591.516101, 1841], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops04_marker = L.marker([1415.396387, 3819.141294], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_photo_ops05_marker = L.marker([1234.869905, 3010.329161], {icon:photo_op_icon}).addTo(ha_photo_ops_group);
...
ha_collectible01_marker = L.marker([1839.512339, 3000.5], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible02_marker = L.marker([1657.00675, 3657], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible03_marker = L.marker([1410.762409, 3002.625], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible04_marker = L.marker([1337.701923, 1765.380468], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible05_marker = L.marker([1337.138499, 1623.625], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible06_marker = L.marker([1433.261249, 1587.375], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible07_marker = L.marker([1902.145436, 1979.137941], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_collectible08_marker = L.marker([2391.501476, 2092.875], {icon:collectible_icon}).addTo(ha_collectibles_group);
...
ha_container_group.addTo(map);
ha_events_group.addTo(map);
ha_feats_group.addTo(map);
ha_collectibles_group.addTo(map);
ha_photo_ops_group.addTo(map);