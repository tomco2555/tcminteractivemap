...
mij2_container_group = L.featureGroup();
mij2_events_group = L.featureGroup();
mij2_photo_ops_group = L.featureGroup();
mij2_feats_group = L.featureGroup();
mij2_collectibles_group = L.featureGroup();

//Container
mij2_container_marker = L.marker([2084.289429, 3377.849094], {icon:mij2_container_icon}).addTo(mij2_container_group);
...
//Events
//Event 01
mij2_event01_marker = L.marker([1821.16393, 3469.242645], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 02
mij2_event02_marker = L.marker([1714.692334, 5206.75], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 03
mij2_event03_marker = L.marker([1662.860549, 5328.579926], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 04
mij2_event04_marker = L.marker([1476.385564, 5435.0625], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 05
mij2_event05_marker = L.marker([1289.643157, 5599.6875], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 06
mij2_event06_marker = L.marker([707.63588, 5311.25], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
//Event 07
mij2_event07_marker = L.marker([541.573345, 6069.0625], {icon:mij2_event_icon}).addTo(mij2_events_group);
...
function createMIJ2FeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["mij2_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(mij2_feats_group);
...
mij2_photo_ops01_marker = L.marker([1475.921853, 5394.871187], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_photo_ops02_marker = L.marker([924.647604, 5943.875], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_photo_ops03_marker = L.marker([1621.871098, 4678.625], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_photo_ops04_marker = L.marker([1612.367547, 5244.375], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_photo_ops05_marker = L.marker([1707.627918, 5065.4375], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_photo_ops06_marker = L.marker([430.048785, 6053.364377], {icon:photo_op_icon}).addTo(mij2_photo_ops_group);
...
mij2_collectible01_marker = L.marker([1618.809459, 4679.75], {icon:collectible_icon}).addTo(mij2_collectibles_group);
...
mij2_collectible02_marker = L.marker([1697.755695, 5063.875], {icon:collectible_icon}).addTo(mij2_collectibles_group);
...
mij2_container_group.addTo(map);
mij2_events_group.addTo(map);
mij2_feats_group.addTo(map);
mij2_collectibles_group.addTo(map);
mij2_photo_ops_group.addTo(map);