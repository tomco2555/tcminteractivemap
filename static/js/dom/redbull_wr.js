...
rb2_container_group = L.featureGroup();
rb2_events_group = L.featureGroup();
rb2_photo_ops_group = L.featureGroup();
rb2_feats_group = L.featureGroup();
rb2_collectibles_group = L.featureGroup();

//CONTAINER
rb2_container_marker = L.marker([721.719568, 5313.834672], {icon:rb2_container_icon}).addTo(rb2_container_group);
...
//EVENTS
//Event 01
rb2_event01_marker = L.marker([747.247696, 5331.913945], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 02
rb2_event02_marker = L.marker([1270.661615, 5179.294288], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 03
rb2_event03_marker = L.marker([843.436605, 4667.816001], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 04
rb2_event04_marker = L.marker([1568.124051, 5459], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 05
rb2_event05_marker = L.marker([1448.698193, 5263.702879], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 06
rb2_event06_marker = L.marker([374.270518, 5235.065055], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
//Event 07
rb2_event07_marker = L.marker([578.79315, 4946.565488], {icon:rb2_event_icon}).addTo(rb2_events_group);
...
function createRB2FeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["rb2_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(rb2_feats_group);
...
rb2_photo_ops01_marker = L.marker([846.443805, 4971.314225], {icon:photo_op_icon}).addTo(rb2_photo_ops_group);
...
rb2_photo_ops02_marker = L.marker([1603.256539, 4966.75], {icon:photo_op_icon}).addTo(rb2_photo_ops_group);
...
rb2_photo_ops03_marker = L.marker([257.53642, 5280.25], {icon:photo_op_icon}).addTo(rb2_photo_ops_group);
...
rb2_collectible01_marker = L.marker([402.75518, 4681.400445], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible02_marker = L.marker([176.856041, 5690.088268], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible03_marker = L.marker([260.59126, 5096.5], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible04_marker = L.marker([1199.592774, 6036.795365], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible05_marker = L.marker([1366.060703, 5972.046341], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible06_marker = L.marker([1406.44868, 5664.698701], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible07_marker = L.marker([1884.888846, 5260.160371], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_collectible08_marker = L.marker([2036.723719, 4709.019925], {icon:collectible_icon}).addTo(rb2_collectibles_group);
...
rb2_container_group.addTo(map);
rb2_events_group.addTo(map);
rb2_feats_group.addTo(map);
rb2_collectibles_group.addTo(map);
rb2_photo_ops_group.addTo(map);