...
oa2_container_group = L.featureGroup();
oa2_events_group = L.featureGroup();
oa2_photo_ops_group = L.featureGroup();
oa2_feats_group = L.featureGroup();
oa2_collectibles_group = L.featureGroup();

//CONTAINER
oa2_container_marker = L.marker([2807.95944, 1561.114996], {icon:oa2_container_icon}).addTo(oa2_container_group);
...
//EVENTS
//Event 01
oa2_event01_marker = L.marker([2588.767026, 1776.782564], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 02
oa2_event02_marker = L.marker([2601.636706, 1556.375], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 03
oa2_event03_marker = L.marker([3017.257106, 2630.967556], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 04
oa2_event04_marker = L.marker([2840.080852, 1891.176038], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 05
oa2_event05_marker = L.marker([2151.913295, 2789.285288], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 06
oa2_event06_marker = L.marker([1920.731605, 3545.769664], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 07
oa2_event07_marker = L.marker([1647.970517, 3094.316913], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 08
oa2_event08_marker = L.marker([1810.832538, 1589.189113], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//Event 09
oa2_event09_marker = L.marker([3029.195075, 2235.114773], {icon:oa2_event_icon}).addTo(oa2_events_group);
...
//FEATS
var OA2featsArr = [[3060.389239, 2131.462189, "escape", "Waimea", "Escape", "390 m", "2,880", "5,400"],  //Feat 01
                   [2604.320591, 2416.007095, "escape", "Wahiawa Edge", "Escape", "520 m", "2,880", "5,400"],  //Feat 02
                   [2536.249135, 2792.629844, "speedtrap", "Hindu Monastery", "Speedtrap", "150.0 km/h", "960", "1,800"],  //Feat 03
                   [1585.388867, 3206.198923, "slalom", "Waimanalo Road", "Slalom", "4,850 PTS", "2,880", "5,400"],  //Feat 04
                   [1609.227326, 2032.446636, "speedtrap", "Mililani Waipio", "Speedtrap", "140.0 km/h", "960", "1,800"],  //Feat 05
                   [2656.053782, 1324.25, "slalom", "Kuaokala Meadows", "Slalom", "4,960 PTS", "1,920", "3,600"],  //Feat 06
                  ]

function createOA2FeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["oa2_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(oa2_feats_group);
...
oa2_photo_ops01_marker = L.marker([1549.515679, 3538.75], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops02_marker = L.marker([2723.428237, 1411.11997], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops03_marker = L.marker([2599.50581, 1644.730373], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops04_marker = L.marker([1613.651084, 1844], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops05_marker = L.marker([1651.68331, 1706.602216], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_photo_ops06_marker = L.marker([1772.58624, 2923.35621], {icon:photo_op_icon}).addTo(oa2_photo_ops_group);
...
oa2_collectible01_marker = L.marker([1504.262163, 3533.375], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible02_marker = L.marker([2900.37726, 2301.279019], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible03_marker = L.marker([2354.185594, 1730.46707], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible04_marker = L.marker([2175.317806, 1413.152902], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible05_marker = L.marker([2029.525241, 3566.75], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible06_marker = L.marker([3127.374445, 2382.596299], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible07_marker = L.marker([3174.874508, 2187.75], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_collectible08_marker = L.marker([2638.148448, 1504.25], {icon:collectible_icon}).addTo(oa2_collectibles_group);
...
oa2_container_group.addTo(map);
oa2_events_group.addTo(map);
oa2_photo_ops_group.addTo(map);
oa2_feats_group.addTo(map);
oa2_collectibles_group.addTo(map);