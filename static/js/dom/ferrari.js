...
ferrari_container_group = L.featureGroup();
ferrari_events_group = L.featureGroup();
ferrari_photo_ops_group = L.featureGroup();
ferrari_feats_group = L.featureGroup();
ferrari_collectibles_group = L.featureGroup();

//CONTAINER
ferrari_container_marker = L.marker([555.888675, 5072.625], {icon:ferrari_container_icon}).addTo(ferrari_container_group);
...
//EVENTS
//Event 01
ferrari_event01_marker = L.marker([543.767085, 5080.375], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 02
ferrari_event02_marker = L.marker([1374.47272, 4706.5], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 03
ferrari_event03_marker = L.marker([891.800551, 4999.5], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 04
ferrari_event04_marker = L.marker([1093.760898, 3599.25], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 05
ferrari_event05_marker = L.marker([494.90085, 5011.619312], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 06
ferrari_event06_marker = L.marker([1875.759467, 4744.686502], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
//Event 07
ferrari_event07_marker = L.marker([465.017999, 5034.75], {icon:ferrari_event_icon}).addTo(ferrari_events_group);
...
function createFerrariFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["ferrari_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(ferrari_feats_group);
...
ferrari_photo_ops01_marker = L.marker([1150.655667, 3605.360701], {icon:photo_op_icon}).addTo(ferrari_photo_ops_group);
...
ferrari_photo_ops02_marker = L.marker([1082.254272, 4023.084032], {icon:photo_op_icon}).addTo(ferrari_photo_ops_group);
...
ferrari_photo_ops03_marker = L.marker([1327.997399, 5278.125], {icon:photo_op_icon}).addTo(ferrari_photo_ops_group);
...
ferrari_photo_ops04_marker = L.marker([583.911769, 4957.348866], {icon:photo_op_icon}).addTo(ferrari_photo_ops_group);
...
ferrari_photo_ops05_marker = L.marker([564.990101, 5071.723388], {icon:photo_op_icon}).addTo(ferrari_photo_ops_group);
...
ferrari_collectible01_marker = L.marker([543.782863, 5074.993757], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_collectible02_marker = L.marker([534.856957, 4991.289992], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_collectible03_marker = L.marker([502.019581, 4961.375], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_collectible04_marker = L.marker([589.263605, 4983], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_collectible05_marker = L.marker([650.183244, 4933.660789], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_collectible06_marker = L.marker([712.75153, 4941.527352], {icon:collectible_icon}).addTo(ferrari_collectibles_group);
...
ferrari_container_group.addTo(map);
ferrari_events_group.addTo(map);
ferrari_feats_group.addTo(map);
ferrari_collectibles_group.addTo(map);
ferrari_photo_ops_group.addTo(map);