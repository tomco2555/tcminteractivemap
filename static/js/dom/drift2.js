...
//CONTAINER
de2_container_marker = L.marker([2810.380379, 1631.125], {icon:de2_container_icon}).addTo(de2_container_group);
...
//EVENTS
//Event 01
de2_event01_marker = L.marker([3046.326482, 2039.561122], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 02
de2_event02_marker = L.marker([2470.936762, 2960.625], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 03
de2_event03_marker = L.marker([1669.138921, 2764.1875], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 04
de2_event04_marker = L.marker([1462.536314, 2682.625], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 05
de2_event05_marker = L.marker([1422.082819, 2346.6875], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 06
de2_event06_marker = L.marker([1417.796506, 1615.827383], {icon:de2_event_icon}).addTo(de2_events_group);
...
//Event 07
de2_event07_marker = L.marker([2000.642319, 1485.969078], {icon:de2_event_icon}).addTo(de2_events_group);
...
de2_photo_ops01_marker = L.marker([3278.959756, 2283.723613], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops02_marker = L.marker([2149.37975, 3041.843149], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops03_marker = L.marker([2890.851983, 2557.796671], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops04_marker = L.marker([1339.958977, 3607.459783], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops05_marker = L.marker([1387.219884, 2856.772792], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops06_marker = L.marker([1320.035451, 2658.621156], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops07_marker = L.marker([1340.243695, 2440.253], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_photo_ops08_marker = L.marker([2298.207887, 2213.029141], {icon:photo_op_icon}).addTo(de2_photo_ops_group);
...
de2_collectible01_marker = L.marker([1306.19766, 2787.125], {icon:collectible_icon}).addTo(de2_collectibles_group);
...
de2_collectible02_marker = L.marker([1461.072692, 2768.323048], {icon:collectible_icon}).addTo(de2_collectibles_group);
...
de2_collectible03_marker = L.marker([1407.503761, 2554.9375], {icon:collectible_icon}).addTo(de2_collectibles_group);
...
de2_collectible04_marker = L.marker([1374.208373, 2424.315599], {icon:collectible_icon}).addTo(de2_collectibles_group);
...
de2_collectible05_marker = L.marker([1223.139554, 2920.25], {icon:collectible_icon}).addTo(de2_collectibles_group);
