...
dc_container_group = L.featureGroup();
dc_events_group = L.featureGroup();
dc_photo_ops_group = L.featureGroup();
dc_feats_group = L.featureGroup();
dc_collectibles_group = L.featureGroup();

//CONTAINER
dc_container_marker = L.marker([1349.381937, 2044.952811], {icon:dc_container_icon}).addTo(dc_container_group);
...
//EVENTS
//Event 01
dc_event01_marker = L.marker([1381.110271, 1787.212389], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 02
dc_event02_marker = L.marker([2901.045399, 2033.813092], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 03
dc_event03_marker = L.marker([2248.531242, 3039.630317], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 04
dc_event04_marker = L.marker([1970.030236, 3417.855574], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 05
dc_event05_marker = L.marker([1228.979947, 3314.394555], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 06
dc_event06_marker = L.marker([1552.774971, 2367.438745], {icon:dc_event_icon}).addTo(dc_events_group);
...
//Event 07
dc_event07_marker = L.marker([2601.687074, 1462.278799], {icon:dc_event_icon}).addTo(dc_events_group);
...
function createDCFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["dc_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(dc_feats_group);
...
dc_photo_ops01_marker = L.marker([2135.320435, 1691.929751], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops02_marker = L.marker([1437.315506, 1595.75], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops03_marker = L.marker([1291.514167, 2805.875], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops04_marker = L.marker([1325.857014, 2674.984953], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_photo_ops05_marker = L.marker([2534.472369, 1756.75], {icon:photo_op_icon}).addTo(dc_photo_ops_group);
...
dc_collectible01_marker = L.marker([1428.405643, 1576.848122], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible02_marker = L.marker([1267.397991, 2812.875], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible03_marker = L.marker([1307.513745, 2879.875], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible04_marker = L.marker([3303.501933, 2272.25], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_collectible05_marker = L.marker([2937.506539, 1777], {icon:collectible_icon}).addTo(dc_collectibles_group);
...
dc_container_group.addTo(map);
dc_events_group.addTo(map);
dc_feats_group.addTo(map);
dc_collectibles_group.addTo(map);
dc_photo_ops_group.addTo(map);