...
rb_photo_ops_group = [];
rb_feats_group = [];
rb_collectibles_group = [];

//CONTAINER
rb_container_marker = L.marker([738.41363, 5319.917868], {icon:rb_container_icon});
...
//EVENTS
//Event 01
rb_event01_marker = L.marker([697.144878, 5475.625], {icon:rb_event_icon});
...
//Event 02
rb_event02_marker = L.marker([744.328628, 5374.011537], {icon:rb_event_icon});
...
//Event 03
rb_event03_marker = L.marker([643.37391, 5460.625], {icon:rb_event_icon});
...
//Event 04
rb_event04_marker = L.marker([631.00239, 5460.625], {icon:rb_event_icon});
...
//Event 05
rb_event05_marker = L.marker([666.255554, 5495.5625], {icon:rb_event_icon});
...
//Event 06
rb_event06_marker = L.marker([678.189697, 5497.8125], {icon:rb_event_icon});
...
//Event 07
rb_event07_marker = L.marker([712.007417, 5402.5], {icon:rb_event_icon});
...
function createRBFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["rb_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]});
...
rb_photo_ops01_marker = L.marker([510.415884, 5446.5], {icon:photo_op_icon});
...
rb_photo_ops02_marker = L.marker([688.383913, 5451.97006], {icon:photo_op_icon});
...
rb_photo_ops03_marker = L.marker([725.850033, 5393.280197], {icon:photo_op_icon});
...
rb_photo_ops04_marker = L.marker([697.92717, 5413.43274], {icon:photo_op_icon});
...
rb_collectible01_marker = L.marker([715.599868, 5358.985518], {icon:collectible_icon});
...
rb_collectible02_marker = L.marker([730.621114, 5394.16408], {icon:collectible_icon});
...
rb_collectible03_marker = L.marker([688.893139, 5412.75], {icon:collectible_icon});
...
rb_collectible04_marker = L.marker([702.696959, 5461.162448], {icon:collectible_icon});
...
rb_collectible05_marker = L.marker([716.835117, 5487.413787], {icon:collectible_icon});
...
rb_collectible06_marker = L.marker([593.391382, 5431.75], {icon:collectible_icon});
...
rb_collectible07_marker = L.marker([641.820585, 5458.6875], {icon:collectible_icon});
...
rb_collectible08_marker = L.marker([616.642106, 5432.347846], {icon:collectible_icon});
...
rb_collectible09_marker = L.marker([543.442807, 5434.734332], {icon:collectible_icon});
...
rb_collectible10_marker = L.marker([750.495989, 5335.739382], {icon:collectible_icon});
...
rb_container_group.push(rb_container_marker);

for(var i = 1; i <= 7; i++) {
    if(i < 10) {
        rb_events_group.push(window["rb_event0" + i + "_marker"]);
    }
    else {
        rb_events_group.push(window["rb_event" + i + "_marker"]);
    }
}

for(var i = 0; i <= 4; i++) {
    rb_feats_group.push(window["rb_feat" + i + "_marker"]);
}

for(var i = 1; i <= 4; i++) {
    if(i < 10) {
        rb_photo_ops_group.push(window["rb_photo_ops0" + i + "_marker"]);
    }
    else {
        rb_photo_ops_group.push(window["rb_photo_ops" + i + "_marker"]);
    }
}

for(var i = 1; i <= 10; i++) {
    if(i < 10) {
        rb_collectibles_group.push(window["rb_collectible0" + i + "_marker"]);
    }
    else {
        rb_collectibles_group.push(window["rb_collectible" + i + "_marker"]);
    }
}

markers_canvas.addMarkers(rb_container_group);
markers_canvas.addMarkers(rb_events_group);
markers_canvas.addMarkers(rb_collectibles_group);
markers_canvas.addMarkers(rb_photo_ops_group);
markers_canvas.addMarkers(rb_feats_group);