...
lbwk_container_group = [];
lbwk_events_group = [];
lbwk_photo_ops_group = [];
lbwk_feats_group = [];
lbwk_collectibles_group = [];

//CONTAINER
lbwk_container_marker = L.marker([1786.76132, 3465.5], {icon:lbwk_container_icon});
...
//EVENTS
//Event 01
lbwk_event01_marker = L.marker([1666.598792, 3527.755731], {icon:lbwk_event_icon});
...
//Event 02
lbwk_event02_marker = L.marker([1436.34481, 2109.122752], {icon:lbwk_event_icon});
...
//Event 03
lbwk_event03_marker = L.marker([1660.259105, 2658.125], {icon:lbwk_event_icon});
...
//Event 04
lbwk_event04_marker = L.marker([1603.25689, 2249.125], {icon:lbwk_event_icon});
...
//Event 05
lbwk_event05_marker = L.marker([2846.115887, 1695.465285], {icon:lbwk_event_icon});
...
//Event 06
lbwk_event06_marker = L.marker([2820.574464, 1938.091299], {icon:lbwk_event_icon});
...
//Event 07
lbwk_event07_marker = L.marker([2899.762991, 2006.680657], {icon:lbwk_event_icon});
...
//Event 08
lbwk_event08_marker = L.marker([1176.843532, 3230.682495], {icon:lbwk_event_icon});
...
//Event 09
lbwk_event09_marker = L.marker([2441.740104, 2281.1875], {icon:lbwk_event_icon});
...
//Event 10
lbwk_event10_marker = L.marker([1434.127883, 3671.5], {icon:lbwk_event_icon});
...
function createLBWKFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["lbwk_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]});
...
lbwk_photo_ops01_marker = L.marker([1997.968473, 2140.854168], {icon:photo_op_icon});
...
lbwk_photo_ops02_marker = L.marker([1282.662361, 1825.270781], {icon:photo_op_icon});
...
lbwk_photo_ops03_marker = L.marker([2006.499086, 3503], {icon:photo_op_icon});
...
lbwk_photo_ops04_marker = L.marker([2706.755062, 1124.25], {icon:photo_op_icon});
...
lbwk_photo_ops05_marker = L.marker([2143.817996, 2887.647318], {icon:photo_op_icon});
...
lbwk_photo_ops06_marker = L.marker([2521.500879, 2234.25], {icon:photo_op_icon});
...
lbwk_photo_ops07_marker = L.marker([1354.34814, 2134.401819], {icon:photo_op_icon});
...
lbwk_photo_ops08_marker = L.marker([1167.133683, 3507.125], {icon:photo_op_icon});
...
lbwk_photo_ops09_marker = L.marker([1235.639202, 2295.75], {icon:photo_op_icon});
...
lbwk_collectible01_marker = L.marker([1430.815787, 2397.625], {icon:collectible_icon});
...
lbwk_collectible02_marker = L.marker([1297.57171, 1816.5], {icon:collectible_icon});
...
lbwk_collectible03_marker = L.marker([1996.728326, 2131.485004], {icon:collectible_icon});
...
lbwk_collectible04_marker = L.marker([2186.25058, 2204.5625], {icon:collectible_icon});
...
lbwk_collectible05_marker = L.marker([3159.194574, 2406.814706], {icon:collectible_icon});
...
lbwk_container_group.push(lbwk_container_marker);

for(var i = 1; i <= 10; i++) {
    if(i < 10) {
        lbwk_events_group.push(window["lbwk_event0" + i + "_marker"]);
    }
    else {
        lbwk_events_group.push(window["lbwk_event" + i + "_marker"]);
    }
}

for(var i = 0; i <= 4; i++) {
    lbwk_feats_group.push(window["lbwk_feat" + i + "_marker"]);
}

for(var i = 1; i <= 9; i++) {
    if(i < 10) {
        lbwk_photo_ops_group.push(window["lbwk_photo_ops0" + i + "_marker"]);
    }
    else {
        lbwk_photo_ops_group.push(window["lbwk_photo_ops" + i + "_marker"]);
    }
}

for(var i = 1; i <= 5; i++) {
    if(i < 10) {
        lbwk_collectibles_group.push(window["lbwk_collectible0" + i + "_marker"]);
    }
    else {
        lbwk_collectibles_group.push(window["lbwk_collectible" + i + "_marker"]);
    }
}

markers_canvas.addMarkers(lbwk_container_group);
markers_canvas.addMarkers(lbwk_events_group);
markers_canvas.addMarkers(lbwk_collectibles_group);
markers_canvas.addMarkers(lbwk_photo_ops_group);
markers_canvas.addMarkers(lbwk_feats_group);