...
dvl_photo_ops_group = [];
dvl_feats_group = [];
dvl_collectibles_group = [];

//CONTAINER
dvl_container_marker = L.marker([2914.363598, 2551.06449], {icon:dvl_container_icon});
...
//EVENTS
//Event 01 Donk
dvl_event01_marker = L.marker([2973.235806, 2616.29509], {icon:dvl_event_d_icon});
...
//Event 02 Donk
dvl_event02_marker = L.marker([1777.595056, 2268], {icon:dvl_event_d_icon});
...
//Event 03 Donk
dvl_event03_marker = L.marker([2627.9001, 2206.75], {icon:dvl_event_d_icon});
...
//Event 04 Donk
dvl_event04_marker = L.marker([2679.64894, 2530.75], {icon:dvl_event_d_icon});
...
//Event 05 Donk
dvl_event05_marker = L.marker([2038.921709, 3021.113723], {icon:dvl_event_d_icon});
...
//Event 06 Donk
dvl_event06_marker = L.marker([1574.491, 2249.306671], {icon:dvl_event_d_icon});
...
//Event 07 Lowrider
dvl_event07_marker = L.marker([2970.938355, 2609.577576], {icon:dvl_event_l_icon});
...
//Event 08 Lowrider
dvl_event08_marker = L.marker([2873.763851, 2035.125], {icon:dvl_event_l_icon});
...
//Event 09 Lowrider
dvl_event09_marker = L.marker([2844.772006, 1974.625], {icon:dvl_event_l_icon});
...
//Event 10 Lowrider
dvl_event10_marker = L.marker([2122.998516, 3052.933528], {icon:dvl_event_l_icon});
...
//Event 11 Lowrider
dvl_event11_marker = L.marker([2069.626968, 3106.85042], {icon:dvl_event_l_icon});
...
//Event 12 Lowrider
dvl_event12_marker = L.marker([1576.434997, 2253.726088], {icon:dvl_event_l_icon});
...
//FEATS
var DvLfeatsArr = [[2211.89082, 2877.967981, "slalom", "Kahaluu Tunnel", "Slalom", "5,220 PTS", "1,920", "3,600", "Dirty South"],  //Feat 01
                   [2038.887455, 2253.284147, "speedtrap", "Kaukonahua River", "Speedtrap", "270.0 km/h", "960", "1,800", "Dirty South"],  //Feat 02
                   [2435.442299, 2248.625, "slalom", "Wahiawa Streets", "Slalom", "5,100 PTS", "2,880", "5,400", "Dirty South"],  //Feat 03
                   [2901.811375, 1955.75, "slalom", "Haleiwa Coast", "Slalom", "3,390 PTS", "2,880", "5,400", "West Side"],  //Feat 04
                   [2961.128867, 2612.1875, "speedtrap", "Laie Village", "Speedtrap", "190.0 km/h", "960", "1,800", "West Side"],  //Feat 05
                   [1591.236916, 2882.344017, "bullseye", "Kalihi Laces", "Bullseye", "6,520 PTS", "4,800", "9,000", "West Side"],  //Feat 06
                  ]

function createDvLFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["dvl_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]});
...
dvl_photo_ops01_marker = L.marker([2920.014288, 2002.172851], {icon:photo_op_icon});
...
dvl_photo_ops02_marker = L.marker([2884.132099, 1979.810599], {icon:photo_op_icon});
...
dvl_photo_ops03_marker = L.marker([2888.727, 2030.722287], {icon:photo_op_icon});
...
dvl_photo_ops04_marker = L.marker([2379.77046, 2220.5], {icon:photo_op_icon});
...
dvl_photo_ops05_marker = L.marker([2402.642296, 2163.5], {icon:photo_op_icon});
...
dvl_photo_ops06_marker = L.marker([2373.315453, 2347.125], {icon:photo_op_icon});
...
dvl_collectible01_marker = L.marker([1340.457746, 2248.422787], {icon:collectible_icon});
...
dvl_collectible02_marker = L.marker([1952.96901, 3241.64265], {icon:collectible_icon});
...
dvl_collectible03_marker = L.marker([2091.908781, 3147.155506], {icon:collectible_icon});
...
dvl_collectible04_marker = L.marker([2310.119872, 2215.121228], {icon:collectible_icon});
...
dvl_collectible05_marker = L.marker([2312.391698, 2093.375], {icon:collectible_icon});
...
dvl_collectible06_marker = L.marker([2869.185004, 1991.5625], {icon:collectible_icon});
...
dvl_collectible07_marker = L.marker([2967.005132, 2606.0625], {icon:collectible_icon});
...
dvl_container_group.push(dvl_container_marker);

for(var i = 1; i <= 12; i++) {
    if(i < 10) {
        dvl_events_group.push(window["dvl_event0" + i + "_marker"]);
    }
    else {
        dvl_events_group.push(window["dvl_event" + i + "_marker"]);
    }
}

for(var i = 0; i <= 5; i++) {
    dvl_feats_group.push(window["dvl_feat" + i + "_marker"]);
}

for(var i = 1; i <= 6; i++) {
    if(i < 10) {
        dvl_photo_ops_group.push(window["dvl_photo_ops0" + i + "_marker"]);
    }
    else {
        dvl_photo_ops_group.push(window["dvl_photo_ops" + i + "_marker"]);
    }
}

for(var i = 1; i <= 7; i++) {
    if(i < 10) {
        dvl_collectibles_group.push(window["dvl_collectible0" + i + "_marker"]);
    }
    else {
        dvl_collectibles_group.push(window["dvl_collectible" + i + "_marker"]);
    }
}

markers_canvas.addMarkers(dvl_container_group);
markers_canvas.addMarkers(dvl_events_group);
markers_canvas.addMarkers(dvl_collectibles_group);
markers_canvas.addMarkers(dvl_photo_ops_group);
markers_canvas.addMarkers(dvl_feats_group);