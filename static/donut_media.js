...
dm_container_group = L.featureGroup();
dm_events_group = L.featureGroup();
dm_photo_ops_group = L.featureGroup();
dm_feats_group = L.featureGroup();
dm_collectibles_group = L.featureGroup();

//CONTAINER
dm_container_marker = L.marker([639.025416, 2956.375], {icon:dm_container_icon}).addTo(dm_container_group);
...
//EVENTS
//Event 01
dm_event01_marker = L.marker([689.767718, 2920.875], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event01_marker.bindPopup("<b style=\"font-size:20px\">Legendary x Rivalry</b><br>\
                              ...
                              <img src=\"img/Donut_Media/legendary_x_rivalry.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 02
dm_event02_marker = L.marker([636.353388, 3062.965193], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event02_marker.bindPopup("<b style=\"font-size:20px\">American x Wrestle</b><br>\
                              ...
                              <img src=\"img/Donut_Media/american_x_wrestle.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 03
dm_event03_marker = L.marker([582.383156, 2679.4375], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event03_marker.bindPopup("<b style=\"font-size:20px\">Hi x Low</b><br>\
                              ...
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/blue_xp.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">8,400</span></span><br>\
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/bucks.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">15,750</span></span><br>\
                              <img src=\"img/Donut_Media/hi_x_low.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 04
dm_event04_marker = L.marker([682.98755, 2481.237695], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event04_marker.bindPopup("<b style=\"font-size:20px\">Mo x Powa</b><br>\
                              ...
                              <img src=\"img/Donut_Media/mo_x_powa.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 05
dm_event05_marker = L.marker([419.508033, 3184.875], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event05_marker.bindPopup("<b style=\"font-size:20px\">Screw x Drifter</b><br>\
                              ...
                              <img src=\"img/Donut_Media/screw_x_drifter.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 06
dm_event06_marker = L.marker([558.972186, 2452.953424], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event06_marker.bindPopup("<b style=\"font-size:20px\">Raptor x Delicacy</b><br>\
                              ...
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/blue_xp.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">9,600</span></span><br>\
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/bucks.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">18,000</span></span><br>\
                              <img src=\"img/Donut_Media/raptor_x_delicacy.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//Event 07
dm_event07_marker = L.marker([694.190084, 2826.4375], {icon:dm_event_icon}).addTo(dm_events_group);
dm_event07_marker.bindPopup("<b style=\"font-size:20px\">German x Qualität</b><br>\
                              ...
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/blue_xp.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">10,800</span></span><br>\
                              <span style=\"display:inline-block;\"><img src=\"img/Misc/bucks.png\" style=\"vertical-align:middle; width:25%; height:25%\"> <span style=\"vertical-align:middle;\">20,250</span></span><br>\
                              <img src=\"img/Donut_Media/german_x_qualitat.png\" class=\"popup_logo\" style=\"margin-top:5px\" onclick=\"this.classList.toggle(&quot;popup_logo_sth&quot;);\">", {
    className: "hstPopup"
});

//FEATS
var featsArr = [[639.798946, 2959.416231, "speedtrap", "Moiliili Heights", "Speedtrap", "210.0 km/h", "960", "1,800"],  //Feat 01
...
function createFeatsMarkers(featsArr) {
    for(var i = 0; i < featsArr.length; i++) {
        window["dm_feat" + i + "_marker"] = L.marker([featsArr[i][0], featsArr[i][1]], {icon:window[featsArr[i][2] +"_icon"]}).addTo(dm_feats_group);
...
createFeatsMarkers(featsArr);

//PHOTO OPS
//Photo Ops 1 Donut x Views - Swimming Pool
dm_photo_ops01_marker = L.marker([618.696373, 2886.205668], {icon:photo_op_icon}).addTo(dm_photo_ops_group);
...
dm_photo_ops02_marker = L.marker([572.322456, 2611.256955], {icon:photo_op_icon}).addTo(dm_photo_ops_group);
...
dm_photo_ops03_marker = L.marker([619.130642, 2901.8125], {icon:photo_op_icon}).addTo(dm_photo_ops_group);
...
dm_photo_ops04_marker = L.marker([565.083361, 2708.395749], {icon:photo_op_icon}).addTo(dm_photo_ops_group);
...
dm_photo_ops05_marker = L.marker([413.317024, 3128.765337], {icon:photo_op_icon}).addTo(dm_photo_ops_group);
...
dm_collectible01_marker = L.marker([442.525404, 2903.615322], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible02_marker = L.marker([471.116803, 2684.707671], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible03_marker = L.marker([529.365619, 2246.036302], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible04_marker = L.marker([630.466226, 1541.152905], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible05_marker = L.marker([536.632803, 1572.959035], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible06_marker = L.marker([1616.943142, 1334.125], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible07_marker = L.marker([2152.445058, 1795.125], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible08_marker = L.marker([2199.185183, 1853.857204], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible09_marker = L.marker([2184.194074, 2001], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible10_marker = L.marker([2368.247293, 2109.5], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible11_marker = L.marker([2467.535873, 2228.648459], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible12_marker = L.marker([2566.124824, 2260.4375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible13_marker = L.marker([2172.029972, 2601.313061], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible14_marker = L.marker([1755.012005, 2992.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible15_marker = L.marker([1513.81932, 3050.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible16_marker = L.marker([1307.93161, 3184.790061], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible17_marker = L.marker([1272.067685, 3358.875], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible18_marker = L.marker([1047.023202, 3479.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible19_marker = L.marker([632.641768, 2956.0625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible20_marker = L.marker([518.206407, 2873.421692], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible21_marker = L.marker([516.269089, 2767], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible22_marker = L.marker([561.383331, 2698.0625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible23_marker = L.marker([635.715395, 2594.37478], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible24_marker = L.marker([544.126424, 2928.747899], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible25_marker = L.marker([693.62224, 2752.4375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible26_marker = L.marker([709.147394, 2658.191167], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible27_marker = L.marker([646.654471, 2692.574234], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible28_marker = L.marker([562.44722, 2712.3125], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible29_marker = L.marker([622.065576, 2069.5625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible30_marker = L.marker([752.868479, 2163.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible31_marker = L.marker([854.716192, 2228.623798], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible32_marker = L.marker([835.993572, 2541.341772], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible33_marker = L.marker([989.857948, 2792.629844], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible34_marker = L.marker([468.819162, 1702.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible35_marker = L.marker([519.199393, 1735.063264], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible36_marker = L.marker([544.36472, 1768.128004], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible37_marker = L.marker([538.890222, 1771.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible38_marker = L.marker([533.506468, 1774.5], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible39_marker = L.marker([466.708299, 1809.1327], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible40_marker = L.marker([593.771163, 3243.625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible41_marker = L.marker([1724.466084, 2143.682596], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible42_marker = L.marker([1219.267788, 2121.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible43_marker = L.marker([2065.933282, 1582.1875], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible44_marker = L.marker([1477.528194, 2186.875], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible45_marker = L.marker([1159.8183, 2319], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible46_marker = L.marker([1628.719827, 2269.017272], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible47_marker = L.marker([1500.195181, 2347.9375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible48_marker = L.marker([1609.686621, 2108.5], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible49_marker = L.marker([1921.630836, 2425.3125], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible50_marker = L.marker([2110.187377, 2014.1875], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible51_marker = L.marker([2014.644457, 2133.959877], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible52_marker = L.marker([1921.944003, 1163.5], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible53_marker = L.marker([1938.367122, 1117.236], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible54_marker = L.marker([1882.770111, 1072.769375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible55_marker = L.marker([1629.135968, 1347], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible56_marker = L.marker([988.186897, 3762.073241], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible57_marker = L.marker([981.134597, 3763.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible58_marker = L.marker([999.755203, 3697.75], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible59_marker = L.marker([996.683016, 3700.996893], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible60_marker = L.marker([883.363164, 3679.606913], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible61_marker = L.marker([886.271795, 3660.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible62_marker = L.marker([912.115016, 3642.625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible63_marker = L.marker([899.289895, 3679.076583], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible64_marker = L.marker([1586.246906, 2829.75], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible65_marker = L.marker([985.581581, 3429.114335], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible66_marker = L.marker([1171.324919, 3452.006917], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible67_marker = L.marker([1159.070269, 3308.9375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible68_marker = L.marker([1106.364927, 3129.566225], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible69_marker = L.marker([1105.380572, 2944.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible70_marker = L.marker([1199.820058, 3126.625], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible71_marker = L.marker([1232.563115, 3117.3125], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible72_marker = L.marker([961.590804, 3198.597525], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible73_marker = L.marker([1007.519194, 3049.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible74_marker = L.marker([1510.659697, 2842.375], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible75_marker = L.marker([2452.122996, 2440.25], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_collectible76_marker = L.marker([757.940928, 1783.6875], {icon:collectible_icon}).addTo(dm_collectibles_group);
...
dm_container_group.addTo(map);
dm_events_group.addTo(map);
dm_feats_group.addTo(map);
dm_collectibles_group.addTo(map);
dm_photo_ops_group.addTo(map);